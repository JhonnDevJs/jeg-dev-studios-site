...
export default function SectionProcess({title, text}) {
  return (
    ...
    <section className="section-process-waves d-flex flex-column justify-content-center align-items-center text-center text-white w-100 h-vh p-3 p-xl-5 position-relative overflow-hidden gradient-effect-x">
