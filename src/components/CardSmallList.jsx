  function CardSmallList({ titulo, subtitulo, list, lastText }) {
    return (
      <div
        className="card col-11 p-2 mb-5"
        style={{
      ...
      >
        <div className="card-body d-flex" style={{ alignItems: "stretch" }}>
          ...
          <div className="flex-grow-1 d-flex flex-column justify-content-center">
            ...
            <h3 className="card-subtitle m-auto mb-2 mt-3 text-start text-white col-12">
              {subtitulo}
            </h3>
            <ul
        ...
        {lastText && (
          <p className="ps-4 text-start text-white fs-4">{lastText}</p>
        )}
      </div>
    );
  }
