          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="w-full md:w-1/2 text-left">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                No entregamos piezas sueltas. Construimos sistemas donde tu
                sitio web, tu SEO y tu identidad visual trabajan en sincronía.
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Monitoreamos el rendimiento y optimizamos cada componente para
                maximizar el retorno de tu inversión digital.
              </p>
            </div>
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6 overflow-hidden transform rotate-y-6 hover:rotate-y-0 transition-transform duration-700 ease-out">
                ...
                <div className="w-full h-40 bg-gray-50 dark:bg-gray-700/30 rounded-xl mb-6 relative flex items-end justify-around px-4 pb-0 overflow-hidden border border-gray-100 dark:border-gray-600">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                    <svg className="w-full h-full" preserveAspectRatio="none">
                      <path
                        d="M0 100 C 50 80, 100 90, 150 40 S 250 20, 350 10"
                        fill="none"
                        stroke="#2563eb"
                        strokeWidth="3"
                        strokeLinecap="round"
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="h-20 bg-gray-50 dark:bg-gray-700/50 rounded border border-dashed border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center p-2">
                    <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 text-purple-600 rounded-full flex items-center justify-center mb-2 font-bold text-xs">
                      SEO
                    </div>
                    <div className="w-12 h-2 bg-gray-200 dark:bg-gray-600 rounded"></div>
                  </div>
                  <div className="h-20 bg-gray-50 dark:bg-gray-700/50 rounded border border-dashed border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center p-2">
                    <div className="w-8 h-8 bg-green-100 dark:bg-green-900/30 text-green-600 rounded-full flex items-center justify-center mb-2 font-bold text-xs">
                      DEV
                    </div>
                    <div className="w-12 h-2 bg-gray-200 dark:bg-gray-600 rounded"></div>
                  </div>
                  <div className="h-20 bg-gray-50 dark:bg-gray-700/50 rounded border border-dashed border-gray-200 dark:border-gray-600 flex flex-col items-center justify-center p-2">
                    <div className="w-8 h-8 bg-orange-100 dark:bg-orange-900/30 text-orange-600 rounded-full flex items-center justify-center mb-2 font-bold text-xs">
                      UX
                    </div>
                    <div className="w-12 h-2 bg-gray-200 dark:bg-gray-600 rounded"></div>
                  </div>
      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white w-full py-12 md:py-20 px-4 gap-3 gradient-effect-y">
        <div className="container max-w-4xl mx-auto w-full mb-8 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-white">
            Una metodología probada para llevar tu proyecto del concepto a la
            realidad.
          </p>
        </div>
        <TimelineProcess
          steps={[
            {
              ...
              description:
                "No empezamos a ciegas. Analizamos tu negocio, tu competencia y tus objetivos para definir la mejor ruta tecnológica y creativa.",
            },
            {
              title: "Diseño y Prototipado",
              description:
                "Creamos la estructura visual y funcional. Validamos la experiencia de usuario (UX) antes de escribir una sola línea de código.",
            },
            {
              title: "Desarrollo Ágil",
              description:
                "Construimos tu solución con las mejores tecnologías (Next.js, React, Node.js). Te mostramos avances constantes para recibir tu feedback.",
            },
            {
              title: "Lanzamiento y Crecimiento",
              description:
                "Desplegamos tu proyecto, aseguramos su rendimiento y te acompañamos con estrategias de SEO y mantenimiento para que siga creciendo.",
            },
          ]}
        />
      </section>
      ...
      <section className="flex flex-col justify-center items-center text-center w-full gap-3 py-12 md:py-20 px-4 gradient-effect-y">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <CardInfo
            ...
            description="No te dejamos solo. Ofrecemos acompañamiento post-entrega para garantizar la estabilidad de tu proyecto."
          />
          <CardInfo
            title="Diseño 100% a Medida"
            description="Sin plantillas genéricas. Cada solución se diseña específicamente para reflejar la identidad de tu marca."
          />
          <CardInfo
            title="SEO Nativo"
            description="Desarrollamos pensando en Google. Tu sitio nace optimizado para posicionarse desde el primer día."
          />
          <CardInfo
            title="Metodología Ágil"
            description="Procesos transparentes con entregas parciales (Sprints) para que siempre tengas control del avance."
          />
          <CardInfo
            title="Tecnología de Vanguardia"
            description="Usamos el stack tecnológico más moderno (Next.js, React) para garantizar velocidad y seguridad."
          />
          <CardInfo
            title="Enfoque en Resultados"
            description="No solo hacemos cosas bonitas; creamos herramientas digitales diseñadas para vender y convertir."
          />
        </div>
      </section>
