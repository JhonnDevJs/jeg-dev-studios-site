					...
					<div className="flex flex-col md:flex-row gap-12 items-center">
						<div className="w-full md:w-1/2 text-left">
							...
							<p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
								Diseñamos interfaces administrativas (Dashboards) que te dan visibilidad completa de tu negocio en tiempo real.
							</p>
							<p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
								Datos centralizados, reportes automáticos y gestión de usuarios en una plataforma segura y escalable.
							</p>
						</div>
			...
			<section className="flex flex-col justify-center items-center text-center text-gray-900 dark:text-white w-full py-12 md:py-20 px-4 gap-3 gradient-effect-y">
				<div className="container max-w-4xl mx-auto w-full mb-8 text-center">
					...
					<p className="text-lg md:text-xl text-gray-600 dark:text-white">
						El éxito de los proyectos de desarrollo de software depende de procesos claros. Nuestro método ágil (Scrum) se enfoca en la transparencia y la entrega de valor constante.
					</p>
				</div>
				<TimelineProcess
					steps={[
						{
							...
							description: "Todo comienza por entender tus necesidades específicas. Nos reunimos contigo para analizar tus objetivos y definir el alcance del proyecto. Nuestro equipo especializado te asesora sobre la mejor solución tecnológica."
						},
						{
							title: "Diseño y Arquitectura (UX/UI)",
							description: "Diseñamos el flujo de usuario y las interfaces (UX/UI) para crear productos de software intuitivos. Definimos la arquitectura tecnológica (frontend, backend, bases de datos) asegurando que la solución sea escalable y segura."
						},
						{
							title: "Desarrollo Ágil (Sprints)",
							description: 'Aquí es donde nuestra fábrica de software cobra vida. Dividimos el proyecto en "Sprints" (ciclos de 1-2 semanas) donde nuestro equipo especializado desarrolla, prueba y te presenta módulos funcionales.'
						},
						{
							title: "Pruebas, Despliegue y Soporte",
							description: "Cubrimos todo el ciclo de vida del desarrollo. Realizamos pruebas de calidad (QA), desplegamos la solución en tu servidor y te acompañamos con soporte para asegurar un lanzamiento exitoso."
						}
					]}
				/>
			</section>
