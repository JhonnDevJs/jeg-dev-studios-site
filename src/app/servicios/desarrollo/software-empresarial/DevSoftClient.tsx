      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white w-full py-12 md:py-20 px-4 gap-3 gradient-effect-y">
        <div className="container max-w-4xl mx-auto w-full mb-8 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-white">
            ...
            Trabajamos de forma organizada y transparente, entregando avances
            constantes para que el resultado supere tus expectativas.
          </p>
        </div>
        <TimelineProcess
          steps={[
            {
              ...
              description:
                "Desde el primer contacto, nos enfocamos en comprender tu visión. Definimos los módulos clave, el diseño y creamos un Product Backlog detallado con todo lo que tu sistema debe incluir.",
            },
            {
              title: "Ciclos de Desarrollo Iterativos (Sprints)",
              description:
                "Dividimos el proyecto en Sprints de 1 o 2 semanas. Planificamos qué módulos trabajar, desarrollamos con código seguro y te mostramos avances funcionales al final de cada ciclo para recibir tu feedback.",
            },
            {
              title: "Revisión Final, Despliegue y Capacitación",
              description:
                "Realizamos una demostración final del software completo. Una vez aprobado, lo instalamos en tus servidores (locales o nube) y capacitamos a tu equipo para que puedan utilizar el nuevo sistema sin problemas.",
            },
          ]}
        />
      </section>
