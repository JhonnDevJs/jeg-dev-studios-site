		...
		<>
			...
			<section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 px-4 text-center">
				<div className="container mx-auto w-full">
					...
					<h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Servicio de Desarrollo de Sitios Web Profesionales</h1>
					...
					<div className="flex flex-col md:flex-row gap-12 items-center">
						<div className="w-full md:w-1/2 text-left">
							...
							<p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
								Tu sitio web es tu oficina digital. Diseñamos estructuras que transmiten solidez, confianza y autoridad en tu sector.
							</p>
							<p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
								Equilibrio perfecto entre información corporativa, presentación de servicios y captación de leads.
							</p>
						</div>
			...
			<section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 px-4 gradient-effect-y">
				<div className="container max-w-4xl mx-auto w-full">
					<h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900 dark:text-white">¿Este Servicio es Para Ti?</h2>
					...
					<div className="grid md:grid-cols-3 gap-8 text-center">
						<CardInfo title="Empresas de Servicios" description="Consultoras, despachos legales, arquitectos y agencias que necesitan generar confianza y captar leads." />
						<CardInfo title="Startups y PyMEs" description="Negocios que buscan una presencia digital sólida para escalar y validar su modelo de negocio." />
						<CardInfo title="Marcas Personales" description="Profesionales que quieren destacar su portafolio y autoridad en su industria." />
					</div>

					<div className="bg-blue-50 dark:bg-gray-800/50 border border-blue-200 dark:border-gray-700 rounded-lg p-6 mt-8 text-center w-full" role="alert">
					...
					steps={[
						{
							...
							description: "Analizamos tu mercado, tu competencia y tus objetivos. Definimos la arquitectura de la información para asegurar que tus usuarios encuentren lo que buscan."
						},
						{
							title: "Diseño UI/UX y Prototipado",
							description: <>Creamos wireframes y diseños de alta fidelidad. Podrás ver cómo lucirá tu <strong>web profesional</strong> antes de escribir una sola línea de código.</>
						},
						{
							title: "Desarrollo y Programación",
							description: "Nuestros desarrolladores construyen el sitio usando las mejores prácticas de código, asegurando compatibilidad con todos los navegadores y dispositivos."
						},
						{
							title: "Lanzamiento y Conexión Social",
							description: <>Configuramos tu dominio, instalamos los certificados de seguridad y conectamos tu sitio con tus <strong>redes sociales</strong> y herramientas de análisis.</>
						}
					]}
				/>
			</section>
