		...
		<>
			...
			<section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 text-center">
				<div className="flex flex-col justify-center items-center mx-auto px-4">
					<h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white">Desarrollo de Comercio Electrónico: Tu Tienda en Línea</h1>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
						<div>
							<div className="p-6 h-full bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
								<h4 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Diseño UX/UI de Alta Calidad</h4>
						...
						<div>
							<div className="p-6 h-full bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
								<h4 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Optimización para Motores de Búsqueda</h4>
								<p className="text-gray-600 dark:text-gray-300 leading-relaxed">
					...
					<div className="flex flex-col md:flex-row-reverse gap-12 items-center">
						<div className="w-full md:w-1/2 text-left">
							...
							<p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
								Diseñamos la página de producto perfecta. Imágenes grandes, precios claros, selectores de variantes intuitivos y botones de compra que destacan.
							</p>
							<p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
								Optimizamos la jerarquía visual para reducir la fricción y aumentar el ticket promedio.
							</p>
						</div>
			...
			<section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 px-4">
				<div className="flex flex-col justify-center items-center w-full" style={{ maxWidth: "900px" }}>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div>
							<div className="p-6 h-full bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
								<h4 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">1. Opciones de Pago Flexibles y Seguras</h4>
								<p className="text-gray-600 dark:text-gray-300 leading-relaxed">
						...
						<div>
							<div className="p-6 h-full bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
								<h4 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">2. Gestión de Contenido con Strapi</h4>
								<p className="text-gray-600 dark:text-gray-300 leading-relaxed">
						...
						<div>
							<div className="p-6 h-full bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm dark:shadow-none hover:border-blue-500/30 transition-colors">
								<h4 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">3. Múltiples Canales de Venta y Atención</h4>
								<p className="text-gray-600 dark:text-gray-300 leading-relaxed">
