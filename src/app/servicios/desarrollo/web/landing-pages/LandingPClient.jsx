			...
			<main>
				...
				<section className="text-white py-5 gradient-effect-x text-center">
					<div className="container">
						...
						<p className="fs-5 lead" style={{ maxWidth: "800px", margin: "auto" }}>
							¿Estás invirtiendo en <strong>campañas de marketing</strong> pero
							no ves resultados? El problema podría no ser tu anuncio, sino tu{" "}
							<strong>página de aterrizaje</strong>. Ofrecemos un servicio
							experto de <strong>desarrollo de landing pages</strong> 100%
							enfocadas en una sola cosa: mejorar tu{" "}
							<strong>tasa de conversión</strong> y capturar más{" "}
				...
				<section className="text-white py-5 gradient-effect-y">
					<div className="container" style={{ maxWidth: "900px" }}>
						...
						>
							Un <strong>creador de landing page</strong> genérico es rápido,
							pero te limita a plantillas lentas que aumentan tu{" "}
						...
						<div className="row mt-5">
							<div className="col-md-6 mb-4">
								...
								<p className="fs-5">
									...
									moderna (Next.js) que carga al instante. Menos espera
									significa una menor <strong>tasa de rebote</strong> y más
									conversiones.
								</p>
							</div>
							<div className="col-md-6 mb-4">
				...
				<section className="text-white py-5 gradient-effect-x text-center">
					<div className="container" style={{ maxWidth: "900px" }}>
						...
						<p className="fs-5">
							...
							estructura probada para convertir. Mira este video donde
							explicamos los 5 elementos clave que toda{" "}
							<strong>landing page exitosa</strong> debe tener.
						</p>
						<div
                ...
                */}
				...
				<FAQ
					faqs={faqs}
					title="Preguntas Frecuentes sobre Páginas de Destino"
				/>

				{/* El CTA Final genérico ya no es necesario, 
            la sección de paquetes es un CTA mucho más fuerte. */}
			</main>
		</>
	);
}
