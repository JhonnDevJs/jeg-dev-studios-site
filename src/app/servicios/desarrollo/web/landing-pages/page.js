...
export const metadata = {
  // Título MEJORADO: Ataca la keyword faltante
  title: "Diseño de Landing Page de Alta Conversión | JEG Dev Studios",
  
  // Descripción MEJORADA: Incluye keywords faltantes
  description:
  ...
  // Keywords MEJORADAS: Se eliminó el stuffing
  keywords:
    "diseño de landing page de alta conversión, creación de páginas de aterrizaje, optimizar landing page, landing page para campañas de marketing, captar clientes potenciales",
  ...
  openGraph: {
    ...
    description:
      "Servicio de creación de páginas de aterrizaje 100% enfocadas en mejorar tu tasa de conversión y captar clientes potenciales. Deja de perder dinero en tus campañas.",
