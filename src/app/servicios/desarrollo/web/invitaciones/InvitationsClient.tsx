  ...
  const features = [
    {
      ...
      description:
        "Un contador dinámico que muestra los días, horas y minutos faltantes para tu gran día.",
    },
    {
      icon: "location_on",
      title: "Mapas Interactivos",
      description:
        "Integración con Google Maps para la Ceremonia y la Recepción, para que nadie se pierda.",
    },
    {
      icon: "photo_library",
      title: "Galería de Fotos",
      description:
        'Un espacio para compartir tus fotos favoritas con tus invitados (Ej. "Mis Recuerdos").',
    },
    {
      icon: "mark_chat_read",
      title: "Confirmación por WhatsApp (RSVP)",
      description:
        'Un botón de "Confirmar Asistencia" que abre un mensaje de WhatsApp listo para enviarte la confirmación.',
    },
    {
      icon: "card_giftcard",
      title: "Código de Vestimenta y Mesa de Regalos",
      description:
        "Secciones claras para indicar el código de vestimenta (Ej. Formal) y tu enlace a la mesa de regalos (Liverpool, Amazon, etc.).",
    },
  ];
      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 text-center">
        <div className="flex flex-col justify-center items-center mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white">
            Invitaciones Digitales para tu Ocasión Especial
          </h1>
      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white py-12 md:py-20 gradient-effect-y text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Nuestros Paquetes de Invitaciones Digitales
          </h2>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center justify-center">
              ...
              <div className="relative w-[280px] h-[580px] bg-gray-900 rounded-[3rem] border-[8px] border-gray-900 shadow-2xl overflow-hidden">
                ...
                <div className="w-full h-full bg-white dark:bg-gray-800 overflow-hidden flex flex-col relative">
                  ...
                  <div className="p-6 text-center -mt-12 relative z-10 flex flex-col items-center">
                    <div className="w-20 h-20 bg-white dark:bg-gray-700 rounded-full shadow-lg mb-4 flex items-center justify-center text-2xl">
                      💍
                    </div>
            ...
            <div className="w-full md:w-1/2 text-left">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Tus invitados verán la invitación desde su celular. Por eso
                diseñamos con un enfoque "Mobile First".
              </p>
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Botones grandes para dedos, mapas que abren la app de GPS
                directamente y tiempos de carga instantáneos, incluso con datos
                móviles.
              </p>
            </div>
          </div>
