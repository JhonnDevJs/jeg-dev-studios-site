  ...
  const features = [
    {
      ...
      description:
        "Te asesoramos para elegir. Apps Nativas (Swift/Kotlin) para máximo rendimiento o Híbridas (React Native) para un desarrollo ágil en ambas plataformas.",
    },
    {
      icon: "dns",
      title: "Backend Robusto",
      description:
        "El cerebro de tu app. Desarrollamos servidores seguros en Java o Node.js que gestionan tus datos, usuarios y lógica de negocio en la nube.",
    },
    {
      icon: "palette",
      title: "Diseño UI/UX Premium",
      description:
        "No usamos plantillas genéricas. Diseñamos interfaces intuitivas y hermosas en Figma, pensadas para retener a tus usuarios.",
    },
    {
      icon: "cloud_done",
      title: "Publicación Garantizada",
      description:
        "Lidiamos con la burocracia de Apple y Google. Nos encargamos de que tu app cumpla las normativas y sea aprobada en las tiendas.",
    },
    {
      icon: "api",
      title: "Integraciones API",
      description:
        "Conectamos tu app con pasarelas de pago, mapas, redes sociales o tu sistema ERP actual para una operación fluida.",
    },
    {
      icon: "support_agent",
      title: "Soporte Continuo",
      description:
        "La tecnología avanza. Ofrecemos mantenimiento para que tu app siga funcionando con las nuevas versiones de iOS y Android.",
    },
  ];
      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white w-full py-12 md:py-20 px-4">
        <div className="flex flex-col justify-center items-center w-full max-w-6xl">
          ...
          <p className="text-lg md:text-xl text-center max-w-3xl mx-auto mb-12 text-gray-600 dark:text-white">
            Desglosamos la tecnología detrás de nuestros paquetes. Calidad de
            código, diseño y seguridad en cada entrega.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative p-8 bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/5 rounded-[2rem] hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl dark:hover:shadow-blue-900/20 flex flex-col"
              >
                <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                  <span className="material-symbols-outlined text-8xl text-blue-600 dark:text-blue-400">
                    {feature.icon}
                  </span>
                </div>
      ...
      <section className="flex flex-col justify-center items-center text-gray-900 dark:text-white w-full py-12 md:py-20 px-4 gap-3">
        <div className="container max-w-4xl mx-auto w-full mb-8 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-white">
            Desde la idea hasta la tienda de aplicaciones. Un flujo de trabajo
            transparente y ágil.
          </p>
        </div>
        <TimelineProcess
          steps={[
            {
              ...
              description:
                "Definimos el alcance, la tecnología (Nativa vs Híbrida) y el modelo de negocio de tu aplicación.",
            },
            {
              title: "Diseño UX/UI (Prototipado)",
              description:
                "Diseñamos cada pantalla en Figma. Validamos la navegación y la experiencia de usuario antes de programar.",
            },
            {
              title: "Desarrollo y Backend",
              description:
                "Programamos la aplicación y configuramos el servidor (Backend) y la base de datos que la potenciará.",
            },
            {
              title: "Testing y QA",
              description:
                "Pruebas rigurosas en dispositivos reales para asegurar estabilidad y rendimiento.",
            },
            {
              title: "Publicación y Lanzamiento",
              description:
                "Gestionamos el despliegue en Google Play y App Store, asegurando que tu app esté disponible para el mundo.",
            },
          ]}
        />
      </section>
