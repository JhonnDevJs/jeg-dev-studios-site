// Ruta: /servicios/seo/web/page.jsx
		...
		<>
			...
			<section className="text-white py-5 gradient-effect-x text-center">
				<div className="container">
					<h1>Consultoría SEO Web y Servicios On-Page</h1>
			...
			<section className="text-white py-5 gradient-effect-x">
				<div className="container" style={{ maxWidth: "900px" }}>
					...
					<div className="row">
						...
						<div className="col-md-6 mb-4">
							<h4>Optimización Técnica On-Page</h4>
							<p>
						...
						<div className="col-md-6 mb-4">
							<h4>Estrategia de Palabra Clave</h4>
							<p>
			...
			<section className="text-white py-5 gradient-effect-y text-center">
				<div className="container" style={{ maxWidth: "800px" }}>
					...
					<nav className="d-flex justify-content-center gap-3 mt-2">
						<Link href="/servicios/seo/local" className="btn-services m-2">
			...
			<section className="text-white py-5 gradient-effect-x text-center">
				<div className="container" style={{ maxWidth: "800px" }}>
					<h2>De Tráfico Orgánico a Clientes Potenciales</h2>
					<p className="lead">
			...
			{/* --- Sección de FAQ --- */}
			<FAQ faqs={faqs} title="Preguntas Frecuentes sobre Consultoría SEO" />
