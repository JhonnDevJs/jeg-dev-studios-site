		...
		<>
			...
			<section className="text-gray-900 dark:text-white py-12 md:py-20 px-4 text-center">
				<div className="container mx-auto w-full">
					<h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Consultoría SEO Web y Servicios On-Page</h1>
					...
					<div className="flex flex-col md:flex-row gap-12 items-center">
						<div className="w-full md:w-1/2 text-left">
							...
							<p className="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
								No basta con aparecer. Tu resultado debe ser irresistible. Optimizamos títulos, meta descripciones y datos estructurados (Rich Snippets).
							</p>
							<p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
								Logramos que tu sitio ocupe más espacio visual en Google, aumentando drásticamente tu tasa de clics (CTR).
							</p>
						</div>
			...
			<section className="text-gray-900 dark:text-white py-12 md:py-20 px-4 gradient-effect-y text-center">
				<div className="container mx-auto max-w-3xl w-full">
					<h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">¿Tu Negocio es Local?</h2>
					...
					<nav className="flex justify-center gap-3 mt-4">
						<Link href="/servicios/seo/local" className="bg-blue-600 text-white hover:bg-blue-700 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 font-bold py-3 px-6 rounded-lg text-lg transition-colors">
					...
					steps={[
						{
							...
							description: "Analizamos el estado actual de tu sitio web, identificando errores técnicos, problemas de indexación y oportunidades de mejora inmediata."
						},
						{
							title: "Investigación de Palabras Clave",
							description: "Descubrimos qué busca exactamente tu cliente ideal. Seleccionamos las keywords con mayor potencial de tráfico y conversión para tu nicho."
						},
						{
							title: "Optimización On-Page",
							description: "Mejoramos la estructura, el contenido y el código de tu sitio. Optimizamos títulos, meta descripciones y velocidad de carga para que Google te ame."
						},
						{
							title: "Autoridad y Link Building",
							description: "Construimos la reputación de tu dominio mediante una estrategia de enlaces de calidad y marketing de contenidos que te posiciona como líder."
						}
					]}
				/>
			</section>
