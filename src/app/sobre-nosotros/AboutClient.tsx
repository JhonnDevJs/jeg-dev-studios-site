      ...
      <main className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white antialiased min-h-screen flex flex-col w-full px-4 md:px-16">
        ...
        <section className=" pt-6 pb-4">
          <h1 className="text-slate-900 dark:text-white tracking-tight text-[32px] font-extrabold leading-tight text-left mb-4">
            ...
            <span className="text-blue-500 bg-blue-500/10 px-1 rounded-md">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-base font-normal leading-relaxed">
            ...
            . Nuestro objetivo es crear experiencias digitales inolvidables a
          ...
          <div className="flex overflow-x-auto no-scrollbar pb-4 gap-4 snap-x snap-mandatory">
            ...
            <div className="flex flex-col min-w-[280px] snap-center bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Crear soluciones digitales que superen las expectativas mediante
                innovación, calidad y un enfoque centrado en la experiencia de
                usuario.
              </p>
            </div>
            ...
            <div className="flex flex-col min-w-[280px] snap-center bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                Ser líderes en desarrollo digital a medida, ayudando a marcas y
                empresas a destacar en un mundo cada vez más conectado.
              </p>
            </div>
            ...
            <div className="flex flex-col min-w-[280px] snap-center bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                <strong>Jumpstart Every Goal:</strong> Trabajamos para activar e
                impulsar cada meta de nuestros clientes utilizando creatividad y
                tecnología.
              </p>
            </div>
          </div>
        ...
        <section className="py-6">
          ...
          <div className="relative pl-4 border-l-2 border-gray-200 dark:border-gray-800 ml-2 space-y-8">
            <div className="relative pl-6">
              ...
              <p className="text-xs font-bold text-blue-600 dark:text-blue-500 uppercase tracking-wider mb-1">
                Mayo 2024
              </p>
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                Jhonatan Espinal Garcia funda JEG Dev Studios con la visión de
                transformar ideas en experiencias digitales.
              </p>
            </div>
            <div className="relative pl-6">
              ...
              <p className="text-xs font-bold text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-1">
                2025
              </p>
              <h3 className="text-slate-900 dark:text-white font-bold text-base">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                Se unen Leonardo Valadez y Fernanda Briseño como cofundadores,
                fortaleciendo las áreas de Backend y UX/UI.
              </p>
            </div>
            <div className="relative pl-6">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                Con el propósito firme de convertirnos en un referente en
                desarrollo web y software empresarial en México.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-4 pb-8 pt-4">
          <div className="rounded-3xl bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 p-6 text-center relative overflow-hidden border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-none">
            ...
            <h2 className="relative text-gray-900 dark:text-white text-xl font-bold mb-2">
