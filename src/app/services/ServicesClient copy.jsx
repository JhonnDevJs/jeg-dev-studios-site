  ...
  return (
    <>
      ...
      <section className="d-flex flex-column w-100 h-100 p-xl-5 p-3 mt-5">
        <h1 className="display-1 text-white pt-5">Desarrollo de sitios web</h1>
        <div className="d-flex flex-md-row flex-column justify-content-start h-100 gap-5">
          <article className="d-flex text-start flex-column w-100 p-0">
            <h2 className="text-white">Paquetes de diseño web</h2>
            ...
            <h2 className="text-white">Lenguajes, frameworks y bibliotecas normalmente utilizados</h2>
            <ul>
              ...
              <li className="text-white">Boostrap</li>
            </ul>
          </article>
