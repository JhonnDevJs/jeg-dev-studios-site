...
- Google App Key (para autenticar Gmail en envío de emails)
...
- **Nodemailer**: Módulo para envío de emails desde Node.js.

#### Dependencias Node.js

Estas son las dependencias que debes instalar en tu proyecto Node.js:
...
3. **Variables de entorno**
   - Crea un archivo `.env.local` en la raíz del proyecto Next.js para tus variables de entorno del frontend si las necesitas.
